...
if 1:
    ...
    # Dataset.
    desc += '-ikea-bedroom-1024';  dataset = EasyDict(tfrecord_dir='/home/ppries/data/records/ikea-bedrooms-1024', resolution=1024);    train.mirror_augment = True

    # Number of GPUs.
    #desc += '-1gpu'; submit_config.num_gpus = 1; sched.minibatch_base = 32; sched.minibatch_dict = {4: 256, 8: 256, 16: 128, 32: 64, 64: 32, 128: 16}
    ...
    desc += '-2gpu'; submit_config.num_gpus = 2; sched.minibatch_base = 8; sched.minibatch_dict = {256: 32, 512: 16}
...
def main():
    ...
    # custom training loop args
    resume_run_id = 'karras2019stylegan-bedrooms-256x256.pkl'
    kwargs.update(resume_run_id=resume_run_id, resume_kimg=0, minibatch_repeats=1,)
